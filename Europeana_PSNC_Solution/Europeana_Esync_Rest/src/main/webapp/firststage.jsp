...
<form action="rest/synchronization1/firstStage" method="post">
<table>
  <tr>
     ...
     <tr>
     <td>source  port :</td>
    <td> <input type="text" name="source_port" value="27017" /></td></tr>
    <tr>
    ...
    <tr>
     ...
     <td> <input type="text" name="destination_port" value="27018"/></td></tr>
     <tr>
     <td>destination database name :</td>
     <td><input type="text" name="destination_databasename" value="users"/></td></tr>
     <tr>
    ...
    <td> <input type="text" name="rabbitmq_username" value="guest"/></td></tr>
     ...
     <td><input type="password" name="rabbitmq_password" value="guest"/></td></tr>
      <tr>
     <td>batch size :</td>
     <td><input type="text" name="batch_size" value="5"/></td></tr>
      <tr>
     <td>synchronization states :</td>
    <td> <select name="states[]" >
     <option>all</option>
     <option>accepted</option>
     <option>to_be_withdrawn</option>
     <option>to_be_deleted</option>
     </select></td></tr>
      <tr>
     ...
     <td><input type="text" name="destination_type" value="mongoCollection"/></td></tr>
    <tr>
